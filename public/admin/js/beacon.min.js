! function(e) {
    ...
    ! function() {
        var e = window.performance || window.webkitPerformance || window.msPerformance || window.mozPerformance,
            t = document.currentScript || ("function" == typeof document.querySelector ? document.querySelector("script[data-cf-beacon]") : void 0),
            n = p(),
            r = window.__cfBeacon,
            o = !1,
            a = !1;
        ...
        if ("function" == typeof PerformanceObserver && (f.getLCP(c), f.getFID(c), PerformanceObserver.supportedEntryTypes && PerformanceObserver.supportedEntryTypes.includes("layout-shift") && f.getCLS(c)), t) {
        ...
        if (e && r && (r.rayId || r.token)) {
            var g = r.token ? r.send && r.send.to ? r.send.to : "https://cloudflareinsights.com/cdn-cgi/rum" : null,
                w = function() {
                    var t = i(e, n, r);
                    if (t && r) {
                        ...
                        a.forEach(function(e, n) {
                            t.resources = e, 0 != n && (t.bypassTiming = !0), r && (1 === r.r && (t.resources = []), d.sendObjectBeacon(o, t, function() {}, !1, g), void 0 !== r.forward && void 0 !== r.forward.url && d.sendObjectBeacon(o, t, function() {}, !1, r.forward.url))
                        })
                    }
                },
                h = function() {
                    var t = i(e, n, r, s);
                    t.resources = [], delete t.tempResources, t.eventType = u.EventType.Additional, r && d.sendObjectBeacon("req_id=" + r.rayId, t, function() {}, !0, g)
                },
                S = function() {
                    a = !0;
            ...
            "complete" === window.document.readyState ? S() : window.addEventListener("load", function() {
                window.setTimeout(S)
            })
        }
    }()
    ...
    function r(e, t, n, r, i) {
        ...
        if (navigator && "function" == typeof navigator.sendBeacon && a && r) {
            ...
            n && (d.onreadystatechange = function() {
                4 == this.readyState && 204 == this.status && n()
            }), d.open("POST", o), d.setRequestHeader("content-type", "application/json"), d.send(c)
        }
    }
    ...
    var r, i, o = function() {
        ...
        p = function(e) {
            ...
            u || (f(), u = !0), addEventListener("visibilitychange", function(t) {
                var n = t.timeStamp;
