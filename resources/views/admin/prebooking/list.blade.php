...
<div class="col-md-12">
    <div class="row">
        ...
        <div class="col-md-10">
            <button  type="button" class="btn btn-info pull-right btn-sm pre-booking-btn" style="margin-left:5px; display: none;">Current Pre-Booking</button>  

            <a href="{{ route('prebooking.expire') }}">
                <button  type="button" class="btn btn-success pull-right btn-sm pre-booking-btn" style="margin-left:5px;">Expire Pre-Booking</button>
            </a>  
