...
<div class="masonry-item col-md-12" style="padding-left:0px !important;padding-right: 0px !important;">
    <div class="bgc-white p-10 bd">
        ...
        <div class="col-md-6" style="padding-left:0px !important">
            ...
            <select class="form-control" style="width: 60%;" name="category_id" id="category_id" required="">
        ...
        <div class="col-md-12 bgc-white p-10 subBtnheight">
            <button type="submit" class="btn btn-primary btn-color pull-right">Submit</button>
        </div>
        </form>
    </div>
</div>
