...
@section('content')
<h4 class="c-grey-900 mB-20">Expire Pre-Booking List</h4>
<div class="col-md-12">
    <div class="row">
        <div class="col-md-2"></div>
        <div class="col-md-10">
            <a href="{{ route('prebooking.index') }}"><button  type="button" class="btn btn-success pull-right btn-sm" style="margin-left:5px;">Current Pre-Booking</button></a>  
