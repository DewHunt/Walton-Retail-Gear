        ...
        <div class="bgc-white p-20 bd new-bp-css">
            <form method="post" action="{{ url('bpDateRangesalesReport') }}">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3 bp-col-xs" style="padding: 0px 5px;">
                        <label>BP</label>
                    ...
                    <div class="form-group col-md-3 bp-col-sm bp-select" style="padding: 0px 5px;">
                    ...
                    <div class="col-md-2 mb-3 bp-col-sm" style="padding: 0px 5px;">
                ...
                <table id="dataExport" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th class="sorting" data-sorting_type="asc" data-column_name="bp_name" style="cursor: pointer;">Name</th>
                            <th class="sorting" data-sorting_type="asc" data-column_name="bp_phone" style="cursor: pointer;">Phone</th>
                            <th class="sorting" data-sorting_type="asc" data-column_name="total_qty" style="cursor: pointer;">Qty</th>
                            <th class="sorting" data-sorting_type="asc" data-column_name="total_sale_amount" style="cursor: pointer;">Amount</th>
                            <th>Order Details</th>
                        </tr>
                    </thead>
                    <tbody>
