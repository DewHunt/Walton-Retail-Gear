...
jQuery(document).on('change','#clientType',function(){
    ...
    if(getType == 'retailer') {
        $html = '<label>Retailer Phone</label>&nbsp;<span class="required">*</span><input type="text" name="search_id" class="form-control" placeholder="Ex: 01711xxxxxx" min="11" required>';

        $('.searchId').append($html);
    }
    else if(getType == 'dealer') {
        $html = '<label>Dealer Code / Phone Number</label>&nbsp;<span class="required">*</span><input type="text" name="search_id" class="form-control" placeholder="Ex: 12345 / 01711xxxxxx" min="3" required>';

        $('.searchId').append($html);
    }
    if(getType == 'emp') {
        $html = '<label>Employee ID</label>&nbsp;<span class="required">*</span><input type="text" name="search_id" class="form-control" placeholder="Ex: 12345" min="3" required>';
